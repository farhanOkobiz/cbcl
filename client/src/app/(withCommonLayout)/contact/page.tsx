        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 md:mt-14 mt-28 lg:mt-0">
            <h2 className="text-3xl lg:text-5xl font-bold text-[#262626] mb-3">
              Get in <span className="text-[#52687f]">Touch</span>
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div className="order-1 lg:order-2 space-y-8">
              ...
              <div>
                ...
                <p className="text-gray-600">Find us at the following location</p>
              </div>
                ...
                <div className="group bg-gradient-to-br from-[#52687f]/5 to-white border border-[#52687f]/20 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:border-[#52687f]/40">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="font-bold text-[#52687f] text-lg mb-1">Address</div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="font-bold text-[#52687f] text-lg mb-1">Hotline</div>
          ...
          <div className="group bg-gradient-to-br from-[#52687f]/5 to-white border border-[#52687f]/20 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:border-[#52687f]/40">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="font-bold text-[#52687f] text-lg mb-1">Email</div>
