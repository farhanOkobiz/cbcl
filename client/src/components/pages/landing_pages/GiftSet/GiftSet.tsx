  ...
  return (
    <div className="Container pt-12 pb-12">
      <div className="flex items-center justify-center pb-2 relative w-[40px] h-[40px] mx-auto">
        <span className="absolute top-[-6px]  left-[-4px]  w-3 h-3 border-t-4 border-l-4  border-[#52687f] rounded-tl-md transition-all duration-300"></span>

        {/* Top-right corner */}
        <span className="absolute top-[-6px]  right-[-4px]  w-3 h-3 border-t-4 border-r-4  border-[#52687f] rounded-tr-md transition-all duration-300"></span>

        {/* Bottom-left corner */}
        <span className="absolute bottom-0  left-[-4px]  w-3 h-3 border-b-4 border-l-4  border-[#52687f] rounded-bl-md transition-all duration-300"></span>

        {/* Bottom-right corner */}
        <span className="absolute bottom-0  right-[-4px]  w-3 h-3 border-b-4 border-r-4  border-[#52687f] rounded-br-md transition-all duration-300"></span>
